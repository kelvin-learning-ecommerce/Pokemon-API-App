...
import 'package:pokemon_app/core/di/app_module.dart' as _i15;
...
import 'package:pokemon_app/data/datasource/pokemon_list_datasource.dart'
    as _i8;
import 'package:pokemon_app/data/repository/pokemon_repository.dart' as _i9;
import 'package:pokemon_app/domain/repository/pokemon_repository_impl.dart'
    as _i10;
import 'package:pokemon_app/domain/usecase/pokemon_detail_usecase.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i8.ApiDataSource>(
        () => _i8.ApiDataSourceImpl(dio: gh<_i3.Dio>()));
    gh.factory<_i9.PokemonRepository>(
        () => _i10.PokemonRepositoryImpl(baseService: gh<_i8.ApiDataSource>()));
    gh.factory<_i11.PokemonDetailUseCase>(
        () => _i11.PokemonDetailUseCase(gh<_i9.PokemonRepository>()));
    gh.factory<_i12.PokemonListUseCase>(
        () => _i12.PokemonListUseCase(gh<_i9.PokemonRepository>()));
    gh.factory<_i13.PokemonBloc>(
        () => _i13.PokemonBloc(gh<_i12.PokemonListUseCase>()));
    gh.factory<_i14.PokemonDetailBloc>(
        () => _i14.PokemonDetailBloc(gh<_i11.PokemonDetailUseCase>()));
    return this;
  }
}
